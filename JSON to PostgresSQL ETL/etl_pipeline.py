...
def process_data(cur, conn, filepath, func):
    """
    - Iterate over all files and populate data tables in musicapp_db
    """
...
def main():
    """
    - Establishes connection with the musicapp_db database and gets
    cursor to it.
    ...
    process_data(cur, conn, filepath='data/song_files', func=process_song_file)
    process_data(cur, conn, filepath='data/log_files', func=process_log_file)
